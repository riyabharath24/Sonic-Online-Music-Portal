...
<head>
	<title>Sonic-Online Music Portal | Uploaded Songs</title>
...
<body>
	...
	<header>
      ...
      aria-haspopup="true" aria-expanded="false">Track</button>
								<div class="dropdown-menu dropdown-primary">
									<a class="dropdown-item" href="kannada_songs.php"><b>Tamil Songs</b></a>
  ...
  <a href="#" class="alert-link">Upload your songs below</a>. And get featured.
	</div><b><center>
