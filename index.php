...
<head>
	<title>Sonic-Online Music Portal</title>
...
<body>
			...
			<div class="col-lg-6 abbot-right px-md-5  py-lg-0 py-3">
				<div class="card">
					<div class="card-body px-lg-5">
						<h3 class="stat-title card-title align-self-center mb-sm-5 mb-3">Sonic
							<br> Online Music Portal </h3>
						<span class="w3-line"></span>
						<p class="card-text align-self-center my-4 text-white">
							Upload your songs on Sonic and save your favourite albums with us here.
						</p>
						<p class="card-text align-self-center mb-5 text-white">Be the part of Sonic. Upload your songs and get featured by great musicians.</p>
	...
	<div class="contact-top text-center" id="more_info">
		<div class="content-contact-top">
			...
			<p class="text-white w-75 mx-auto">Sonic-Online Music Portal
			</p>
		</div>
	</div>
	<!-- //contact top -->
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>email</h6>
								<p>
									<a href="mailto:example@email.com" class="text-dark">admin@sonic.com</a>
								</p>
							</div>
						</div>
					</div>
	...
	<div class="cpy-right text-center">
		<p>© 2023 Sonic. All rights reserved</p>
	</div>
	<!-- //copyright -->
